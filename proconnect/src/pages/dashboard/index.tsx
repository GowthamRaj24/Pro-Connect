...
export const initiatives = [
  {
    ...
    short_description:
      "Improving the facilities and resources of local colleges.",
    long_description:
  ...
  },
  {
    ...
    image:
      "https://www.cpccfoundation.org/files/52227ADD-E576-48F7-B264-95C27973EA24--ED11E1AE-FDC0-4242-8E5A-2FA844B3BC04/opp-scholars-chromebook-distro-1-1.jpg?nc=07242019100952",
  ...
  },
  {
    ...
    image:
      "https://unitedwaynca.org/wp-content/uploads/2021/12/DSC_5069-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://media.post.rvohealth.io/wp-content/uploads/2020/09/Blood_Donation-732X549-thumbnail-732x549.jpg",
...
const UpdateAlumniProfile = () => {
  return (
    <div
      className="w-160 h-96 rounded-md bg-white fixed"
      style={{
        top: "50%",
        left: "50%",
    ...
    <>
      ...
      <div className="w-256 mx-auto rounded-md my-5 relative p-3 py-5">
        ...
        <div className="grid grid-cols-3 gap-3 my-2 mt-6">
          <button
            className="bg-gray-800 text-white items-center justify-center flex flex-row h-32 rounded-md"
            onClick={() => {
              router.push("/reviews");
            }}
          >
