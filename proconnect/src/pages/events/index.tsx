...
const EventsPage: React.FC = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="w-full p-3  grid grid-cols-12">
          ...
          <div className="col-start-6 col-end-13">
            ...
            <div className="mt-5">
                <p className="flex flex-row gap-1 items-center my-2"><MdOutlineDateRange size={20}/> 12th August 2021
                </p>
                <p className="flex flex-row gap-1 items-center my-2"><IoMdTime size={20}/> 10:00AM
                </p>
                <p className="flex flex-row gap-1 items-center my-2"><CiLocationOn size={20}/> Online
                </p>
            </div>
            <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-row items-center gap-3 w-full rounded-md px-4" style={{
                ...
                <div className="flex flex-row items-center gap-3 w-full rounded-md px-4 bg-black" style={{
                    border:'lightgray 1px solid'
                }}>
      ...
      >
        <div className="flex flex-row p-2 rounded-md gap-3 w-80 relative" style={{
          border:'lightgray 1px solid'
        }}>
            <div>
            <Image
      ...
      >
        {currentEvent === "description" ? (<p className="bg-gray-700  text-white p-1 px-4 rounded-lg">Description</p>):(<p className=" p-1 px-4 rounded-lg">Description</p>)}
        {currentEvent === "datesAndDeadlines" ? (<p className="bg-gray-700  text-white p-1 px-4 rounded-lg">Dates & Deadlines</p>):(<p className=" p-1 px-4 rounded-lg">Dates & Deadlines</p>)}
        {currentEvent === "faqs" ? (<p className="bg-gray-700  text-white p-1 px-4 rounded-lg">FAQ'S</p>):(<p className=" p-1 px-4 rounded-lg">FAQ'S</p>)}
      </div>
      <div
